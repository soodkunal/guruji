...
function g8_var_init(){
		...
		export G8_CGPT_KEY="bhhhhhhhh1"
		export G8_ELAB_KEY="sgggggg"
		...
		export G8_GPT_TXT="$G8_HOME/$G8_PROJ/ops/$G8_PROJ_gpt.txt"
		...
		export G8_PROF_ID="usha"

		# URL to initial txt file
		# G8_TXT is the file, provided by prof
		export G8_TXT="https://drive.google.com/file/d/1dhfKDQaBAhp1Jbb3eEb0aw8q9IDt-hKz/view?usp=drive_link"
		#URL to sample img
		# This seems not to be used in our version numbers
		export G8_IN_SAMPLE_IMG="https://drive.google.com/drive/folders/1lkYtQr7s2pZ-2HQzRRxj7V1RkhC-cmeJ?usp=drive_link"
		#Path to sample audio
		export G8_IN_SAMPLE_AUD="https://drive.google.com/drive/folders/1nmhUhLOQLzCtJRepXd3C6Ky28_BGgKSW?usp=drive_link"
		#Path to sample video
		export G8_IN_SAMPLE_VID="https://drive.google.com/file/d/1Rh6D7uWcOkLfSHrDwQexYW3cwWo-67jX/view?usp=sharing"	
		#Path to metadat for txt file
		export G8_MTDT="https://drive.google.com/file/d/1M95l9-k1jn_Q_oCysRnth1EkbLkbG9On/view?usp=sharing"
		...
		export G8_IN_PROF_TXT="$G8_HOME/$G8_PROJ/input/g8_in_$G8_PROF_NAME.txt"
		# G8_IN_SAMPLE_IMG is the image file of the professor
		export G8_IN_SAMPLE_IMG="$G8_HOME/$G8_PROJ/in/g8_in_$G8_PROF_NAME.jpg"
		# G8_IN_SAMPLE_AUD is the file that has audio sample from professor
		export G8_IN_SAMPLE_AUD="$G8_HOME/$G8_PROJ/in/g8_in_$G8_PROF_NAME.mp3"
		...
		export G8_IN_MTDT= "$G8_HOME/$G8_PROJ/input/g8_in_$G8_PROF_NAME.txt"
		#OPS#
		...
		export G8_OPS_GPT_TXT="$G8_HOME/$G8_PROJ/ops/g8_ops_gpt_$G8_PROF_NAME.txt"

		# This is the intermediate complete audio file recieved from eleven labs
		export G8_OPS_AUDIO_FILE="$G8_HOME/$G8_PROJ/ops/g8_ops_11lab_$G8_PROF_NAME.wav"
		...
		export G8_OUTPUT_LECTURE_FILE="$G8_HOME/$G8_PROJ/out/g8_out_$G8_PROF_NAME_$$.mp4"
}
...
function g8_step1_get_from_prof() {
  ...
  "culture": "Indian"
    ...
    wget -q -O "$G8_IN_PROF_TXT" "$G8_TXT" || { echo " ! Failed to download text."; return 1; }

    echo " + Downloading metadata file to: $G8_IN_MTDT"
    wget -q -O "$G8_IN_MTDT" "$G8_MTDT" || { echo " ! Failed to download metadata."; return 1; }
